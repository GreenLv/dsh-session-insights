...
| [awesome-dsh-plugin market screenshots](https://awesome-dsh-plugin.com/p/GreenLv/dsh-session-insights/) | Keyed by `https://github.com/GreenLv/dsh-session-insights` | Listed | Screenshot registration [PR #2937](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin/pull/2937) merged (commit `4886a9a4`, 2026-08-24); read back from the published catalog — the entry now carries a `screenshots` array (2 images) plus the npm install command (re-read 2026-08-25) |
