...
| [dshplugin.app](https://dshplugin.app/plugins/dsh-session-insights) | `dsh-session-insights` | Listed | Anonymous directory page read back 2026-08-30. Directory visibility is independent of package installation, runtime behavior, and screenshot rendering. |
