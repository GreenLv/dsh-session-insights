...
| [dsh-market.com](https://dsh-market.com/) workshop | `dsh-session-insights` (category `tools`) | Pending merge | Community-index registration [PR #1055](https://github.com/zhu1090093659/dsh-web-ui/pull/1055) to `zhu1090093659/dsh-web-ui` (`packages/dsh-community-plugins/community.json`); after merge, the entry is deployed to dsh-market.com by `deploy-market.yml` — update this row after a public readback |
